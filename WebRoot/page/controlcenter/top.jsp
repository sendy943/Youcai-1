...
bgColor=#6386de border=0 valign="top">
  <TBODY>
  <TR vAlign=top>
      <TD vAlign=top width="450" class="My" Align=left><img src="/images/global/yc.jpg" border=0 /></TD>
    <TD width="124">
      ...
      bgColor=#6386de border=0>
        ...
        <TR height=38>
          ...
          <TD vAlign=center align=right><A 
            ...
            href="/control/center/right"  target="mainframe">
            ...
            onmouseout="MM_nbGroup('out');" href="/page/help/help_sys.jsp"  target="mainframe"><IMG id=OAHeader_r1_c3 
