...
<link href="/core/css/global/orderconfirm.css" rel="stylesheet" type="text/css">
...
<TABLE cellSpacing=0 cellPadding=0 align=center border=0>
  <TBODY>
  <TR>
    <TD><a href="/index.jsp"><IMG src="/core/images/global/yc.jpg" ></a>&nbsp;&nbsp;<IMG height=36 src="/core/images/buy/az-s-checkout-confirm-banne.gif" >
  </TD></TR>
  </TBODY>
</TABLE>
<BR>

<form action="/core/customer/shopping/manage/saveOrder" method="post">
            ...
            border=0>
              ...
              <TR>
                <TD vAlign=top width=7 bgColor=#3163ce height=30><IMG height=17 
                  src="/core/images/buy/az-s-top-left-blue-corner.gif" width=17></TD>
                <TD bgColor=#3163ce Align="top">
                  <DIV align=center><IMG height=21 src="/core/images/buy/az-s-click-place-your-order.gif" width=420> </DIV></TD>
                <TD bgColor=#3163ce Align=right>
                  <DIV id=layer_finish1><INPUT onClick="return validateForm()" type="image" height=37 alt=订单确认 width=116 src="/core/images/buy/az-s-place-order_01.gif" border=0> </DIV></TD>
                <TD vAlign=top width=7 bgColor=#3163ce><IMG height=17 src="/core/images/buy/az-s-top-right-blue-corner.gif"  width=17></TD></TR></TBODY></TABLE>
              ...
              <TR>
                <TD vAlign=top>
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    <TBODY>
                    <TR>
                      <TD width=6><IMG height=20 src="/core/images/buy/az-s-spc-tl-inside-drksnd.gif" width=6></TD>
                      <TD bgColor=#bbbb9e>
                        <DIV class=font14 align=center><STRONG>配送详情</STRONG></DIV></TD>
                      <TD width=6><IMG height=20 src="/core/images/buy/az-s-spc-tr-inside-drksnd.gif" width=6></TD></TR></TBODY></TABLE>
                  <TABLE cellSpacing=0 cellPadding=3 width="100%" border=0>
                    <TBODY>
                      <TR>
                        <TD width=184 
                        bgColor=#eeeeee>&nbsp;<STRONG>商品信息：</STRONG><IMG onclick="turnToCartUI()" height=17 src="/core/images/buy/az-s-change.gif" width=45 border=0></TD>
...
<c:forEach items="${cart.items}" var="item">
      <TR>
		...
		<STRONG><a href="/core/front/product/detailShow?productId=${item.product.productId }" target="_blank">${item.product.name }</A></STRONG><span class="h3color"><c:forEach items="${item.product.styles}" var="style">[颜色：${style.name}]</c:forEach></span> </TD>
        ...
        <TD width="21%">单价：￥<span class="Price">${item.product.salePrice }元</SPAN></TD>
                  ...
                  <TABLE cellSpacing=0 cellPadding=3 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      <TD bgColor=#eeeeee><IMG onclick="turnToDeliverWayUI()" height=17 src="/core/images/buy/az-s-change.gif" width=45 border=0></TD></TR>
				  </TBODY></TABLE>
                  ...
                  <TABLE cellSpacing=0 cellPadding=3 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      <TD width="756" bgColor=#eeeeee><img onclick="turnToPaymentWayUI()" height=17 src="/core/images/buy/az-s-change.gif" width=45 border=0></TD>
                    </TR></TBODY></TABLE>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" align="center" bgColor="#4480dd" border=0>
              <TBODY>
              <TR>
                <TD vAlign="bottom" width=7 height=30><IMG height=17 src="/core/images/buy/az-s-bottom-left-blue-corner.gif"  width=17></TD>
                <TD Align="right">
                  <DIV id="layer_finish2"><INPUT onClick="return validateForm()" type="image" height=37 alt="订单确认" width="116" src="/core/images/buy/az-s-place-order_02.gif" border=0> </DIV></TD>
                <TD vAlign=bottom width=7><IMG height=17 
                  src="/core/images/buy/az-s-bottom-right-blue-corner.gif" 
