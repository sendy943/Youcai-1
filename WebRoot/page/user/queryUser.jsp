...
<input type="hidden" name="query" value="true">
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input type="text" name="user.name" size="30" maxlength="20"/></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">姓名：</div></td>
      <td width="78%"> <input type="text" name="user.realname" size="15" maxlength="10"/></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">电子邮件：</div></td>
      <td width="78%"> <input type="text" name="user.email" size="50" maxlength="45"/></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
