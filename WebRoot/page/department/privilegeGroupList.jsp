...
<form action="/core/control/privilegegroup/list" method="post">
...
<c:forEach items="${privilegeGroups}" var="entry">
    <tr>
      ...
      <a href="/core/control/privilegegroup/showUpdateUI?groupId=${entry.groupId}">
      ...
      <a href="/core/control/privilegegroup/delete?groupId=${entry.groupId}">删除</a></yc:permission></c:if></div></td>
	</tr>
</c:forEach>
    <!----------------------LOOP END------------------------------->
    <tr> 
      <td bgcolor="f5f5f5" colspan="4" align="center"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr> 
            <td width="5%"></td>
              ...
              <input type="button" class="frm_btn" onClick="javascript:window.location.href='/core/control/privilegegroup/showAddUI'" value="添加权限组"> &nbsp;&nbsp;
              </yc:permission>
            </td>
          </tr>
        </table></td>
