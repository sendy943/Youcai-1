...
<c:forEach items="${departments}" var="entry">
    <tr>
      ...
      <td bgcolor="f5f5f5"> <div align="center">
         ...
         <a href="#" onclick="if(confirm('确定删除吗？')) location.href='/core/control/department/delete?departmentId=${entry.departmentId}'">删除</a>
         </yc:permission>
      </div></td>
	</tr>
</c:forEach>
      ...
      <td bgcolor="f5f5f5" colspan="4" align="center"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr> 
            <td width="5%"></td>
              ...
              <input type="button" class="frm_btn" onClick="javascript:window.location.href='/core/page/department/addDepartment.jsp'" value="添加部门"> &nbsp;&nbsp;
              </yc:permission>
            </td>
          </tr>
        </table></td>
